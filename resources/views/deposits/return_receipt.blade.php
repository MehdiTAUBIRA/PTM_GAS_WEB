...
<body>
    <div class="container">
        ...
        <div class="receipt-info">
            <p><strong>Date du remboursement:</strong> {{ date('d/m/Y', strtotime($document->document_date)) }}</p>
        </div>
        ...
        <div class="info-box">
            <h2>Détails du dépôt initial</h2>
            <div class="info-row">
        ...
        <div class="deposit-amount">
            Montant remboursé: {{ number_format(abs($document->amount), 2, ',', ' ') }} €
        </div>

        <div class="footer">
            <p>Ce document certifie que le dépôt de garantie a été remboursé au client suite à la restitution du produit.</p>
