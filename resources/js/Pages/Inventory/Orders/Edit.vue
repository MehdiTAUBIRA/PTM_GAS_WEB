...
const form = useForm({
    id_depot: props.inventoryOrder.id_depot,
    id_employee_assigned: props.inventoryOrder.id_employee_assigned,
    comments: props.inventoryOrder.comments || '',
    products: props.inventoryOrder.details.map(detail => ({
...
const addProduct = () => {
    form.products.push({
        id_inventory_order_detail: null,
        id_product: '',
        expected_quantity: 0
    });
};
...
const submit = () => {
    form.put(route('inventory-orders.update', props.inventoryOrder.id_inventory_order), {
        onSuccess: () => {
...
<template>
    <Head title="Modifier un ordre d'inventaire" />

    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between items-center">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                    Modifier l'ordre d'inventaire #{{ inventoryOrder.id_inventory_order }}
                </h2>
                <div class="flex gap-2">
                    <Link
                        :href="route('inventory-orders.show', inventoryOrder.id_inventory_order)"
